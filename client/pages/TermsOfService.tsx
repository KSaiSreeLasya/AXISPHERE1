      ...
      <section className="py-16">
        <div className="container mx-auto px-6 max-w-3xl prose prose-neutral dark:prose-invert">
          ...
          <p>
            ...
            products, and services provided by Axisphere Media Worx ("Axisphere", "we", "us").
          ...
          <h2>2. Accounts</h2>
          <p>
            Some features may require an account. You agree to provide accurate information and keep it up to date.
            You are responsible for safeguarding your credentials and for all activity under your account.
          </p>

          <h2>3. Intellectual Property</h2>
          <p>
            The Services and all materials therein are owned by Axisphere or our licensors and are protected by
            intellectual property laws. You may not copy, modify, distribute, sell, or lease any part of the Services
          ...
          <p>
            The Services may integrate with third-party tools (e.g., analytics, payment gateways, databases).
          ...
          <p>
            ...
            express or implied. We disclaim all warranties of merchantability, fitness for a particular purpose,
            and non-infringement.
          </p>

          <h2>7. Limitation of Liability</h2>
          <p>
            To the fullest extent permitted by law, Axisphere will not be liable for any indirect, incidental,
            special, consequential, or punitive damages arising from your use of the Services.
          </p>

          <h2>8. Indemnification</h2>
          <p>
            You agree to indemnify and hold harmless Axisphere and its affiliates from any claims, liabilities,
          ...
          <p>
            ...
            Terms or if we need to do so to comply with legal requirements.
          </p>

          <h2>10. Governing Law</h2>
          <p>
            These Terms are governed by the laws of India, and disputes will be subject to the exclusive jurisdiction
            of the courts located in Bengaluru, Karnataka, India.
          </p>

          <h2>11. Changes to Terms</h2>
          <p>
            We may update these Terms from time to time. The updated version will be indicated by an updated
            "Last updated" date. Continued use of the Services after changes become effective constitutes acceptance
