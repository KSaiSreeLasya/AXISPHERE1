    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-6 py-16">
          <div className="flex items-center justify-between gap-4">
            <h1 className="text-4xl md:text-6xl font-extrabold">
              <span className="bg-gradient-to-r from-gold-400 to-gold-600 bg-clip-text text-transparent">Privacy Policy</span>
            </h1>
            <Link
              to="/"
          ...
          <p className="mt-4 max-w-3xl text-foreground/80">
            Learn how we collect, use, and protect your information across our products and services.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-6 max-w-3xl prose prose-neutral dark:prose-invert">
          <p>
            This Privacy Policy explains how Axisphere Media Worx ("Axisphere", "we", "us") collects, uses, and protects your information when you
