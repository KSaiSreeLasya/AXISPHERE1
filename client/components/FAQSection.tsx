    ...
    <section id="faqs" className="py-24 bg-background">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-foreground/70">Quick answers to common questions about our AI-driven marketing services.</p>
        </div>
        ...
        <Accordion type="single" collapsible className="max-w-3xl mx-auto">
          {faqs.map((item, idx) => (
            <AccordionItem key={idx} value={`item-${idx}`}>
              ...
              <AccordionContent className="text-foreground/70">{item.a}</AccordionContent>
            </AccordionItem>
          ))}
        </Accordion>
