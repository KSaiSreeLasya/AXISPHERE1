          ...
          >
            ...
            >
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Founded in 2018, Axisphere Works LLP emerged from a simple
                belief: exceptional brands deserve exceptional digital
                experiences. What started as a boutique design studio has
                evolved into a full-service creative agency, trusted by industry
                leaders worldwide.
              </p>
            </motion.div>
  ...
  return (
    ...
    >
      <div className="relative rounded-2xl border border-border/50 hover:border-gold-500/30 hover:shadow-luxury transition-all duration-500 h-full">
        <div
          className={`relative h-[720px] md:h-[760px] preserve-3d transition-transform duration-700 ${isHovered ? "rotate-y-180" : ""}`}
        >
          {/* Front: Image + name */}
